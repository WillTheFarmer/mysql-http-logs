-- drop procedure -----------------------------------------------------------
DROP PROCEDURE IF EXISTS `parse_access_nginx_combined`;
-- create procedure ---------------------------------------------------------
DELIMITER //
CREATE DEFINER = `root`@`localhost` PROCEDURE `parse_access_nginx_combined`
(
...
BEGIN
  ...
  DECLARE module_name VARCHAR(255) DEFAULT 'parse_access_nginx_combined';
