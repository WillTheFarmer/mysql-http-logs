-- drop procedure -----------------------------------------------------------
DROP PROCEDURE IF EXISTS `import_access_nginx_combined`;
-- create procedure ---------------------------------------------------------
DELIMITER //
CREATE DEFINER = `root`@`localhost` PROCEDURE `import_access_nginx_combined`
(
...
BEGIN
  ...
  DECLARE module_name VARCHAR(255) DEFAULT 'import_access_nginx_combined';
